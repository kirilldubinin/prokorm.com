...
export default [
{
  ...
  dosing: [
    'Комбикорм применяют рыбам при температуре воды в водоеме не ниже 12° С, с лечебной целью 5–10 суток, с лечебно-профилактической - 3 суток',
  ...
  composition: `Пшеница, подсолнечный шрот, горох экструдированный, рыбная мука, рапсовый
  жмых, кукуруза, дрожжи кормовые, масло соевое, витаминно-минеральный премикс,
  ветеринарный препарат (Антибак 100).`,
}, {
  code: '690402',
  name: 'Pescary',
  ...
  осложненных бактериальной инфекцией.`,
  dosing: [
    'Комбикорм применяют рыбам при температуре воды в водоеме не ниже 20° С',
    '2 кг на 100 кг рыбы в сутки, 14 дней подряд.'
  ],
  ...
  composition: `Пшеница, подсолнечный
  шрот, горох экструдированный, рыбная мука, рапсовый жмых, кукуруза, дрожжи кормовые,
  масло соевое, витаминно-минеральный премикс, ветеринарный препарат (Крустацид).`,
}] as IProduct[]
